            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">陪玩人员编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="peiwanrenyuanUuidMumber" id="peiwanrenyuanUuidMumber"  placeholder="陪玩人员编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">陪玩人员姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="peiwanrenyuanName" id="peiwanrenyuanName"  placeholder="陪玩人员姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">陪玩人员手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="peiwanrenyuanPhone" id="peiwanrenyuanPhone"  lay-verify="phone|required"   placeholder="陪玩人员手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">陪玩人员身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="peiwanrenyuanIdNumber" id="peiwanrenyuanIdNumber"  lay-verify="identity|required"   placeholder="陪玩人员身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">价格/小时:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="peiwanrenyuanJiage" id="peiwanrenyuanJiage"  lay-verify="double|required"   placeholder="价格/小时" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">擅长游戏:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="peiwanrenyuanShanchang" id="peiwanrenyuanShanchang"  placeholder="擅长游戏"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
