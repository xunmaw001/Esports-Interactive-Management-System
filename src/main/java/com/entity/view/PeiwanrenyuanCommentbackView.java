...
public class PeiwanrenyuanCommentbackView extends PeiwanrenyuanCommentbackEntity implements Serializable {
	...
	public PeiwanrenyuanCommentbackView() {

	}

	public PeiwanrenyuanCommentbackView(PeiwanrenyuanCommentbackEntity peiwanrenyuanCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, peiwanrenyuanCommentbackEntity);
