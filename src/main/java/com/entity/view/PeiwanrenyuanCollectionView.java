...
public class PeiwanrenyuanCollectionView extends PeiwanrenyuanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String peiwanrenyuanCollectionValue;
	...
	public PeiwanrenyuanCollectionView() {

	}

	public PeiwanrenyuanCollectionView(PeiwanrenyuanCollectionEntity peiwanrenyuanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, peiwanrenyuanCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getPeiwanrenyuanCollectionValue() {
				return peiwanrenyuanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setPeiwanrenyuanCollectionValue(String peiwanrenyuanCollectionValue) {
				this.peiwanrenyuanCollectionValue = peiwanrenyuanCollectionValue;
			}
